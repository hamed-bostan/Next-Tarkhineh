...
export default function FoodCard({ item }) {
  ...
  return (
    <div className="text-xs border border-[#CBCBCB] rounded-sm overflow-hidden w-24 md:w-52 md:rounded-lg">
      <div className="relative">
        <Image
          ...
          width={110}
          height={110}
          className="h-12 w-full object-cover md:h-36"
        />
      ...
      <div className="text-center py-1 text-[#353535] md:text-sm ">
